...
import net.kdt.pojavlaunch.PojavLauncherPlayClient;
import net.kdt.pojavlaunch.input.XrInput;
...
public class OpenXRState {
    ...
    public void tryInitialize() {
        ...
        session = null;
        PojavLauncherPlayClient.POJAV_RENDERER.setSession(null);
        ...
        try {
            ...
            if (instance != null) instance.close();
            instance = null;
            PojavLauncherPlayClient.OPEN_XR_STATE.session = null;
        }
    }
    ...
    public OpenXRInstance createOpenXRInstance() throws XrException {
        try (MemoryStack stack = stackPush()) {
            ...
            androidCreateInfo.set(
                    ...
                    NULL,
                    memGetAddress(PojavLauncherNativeLoad.getJVMPtr()),
                    memGetAddress(PojavLauncherNativeLoad.getApplicationActivityPtr())
            );
    ...
    public boolean loop() {
        if (instance != null && PlayOptions.xrUninitialized) {
            if (session != null) session.close();
            session = null;
            PojavLauncherPlayClient.MCXR_GAME_RENDERER.setSession(null);
            if (instance != null) instance.close();
            instance = null;
        ...
        if (session.running) {
            ...
            PojavLauncherPlayClient.MCXR_GAME_RENDERER.renderFrame(disabled);
            return !PojavLauncherPlayClient.MCXR_GAME_RENDERER.isXrMode();
        }
        return true;
    }
